      ...
      <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1fr 480px', alignItems: 'center', maxWidth: '1380px', margin: '0 auto', width: '100%', padding: '80px 48px 60px', gap: '60px' }}>
        ...
        <div>
          ...
          <h1 style={{ fontFamily: 'Crimson Pro, Georgia, serif', fontSize: 'clamp(42px, 4.5vw, 68px)', fontWeight: 400, lineHeight: 1.1, letterSpacing: '-0.01em', marginBottom: '28px', color: '#ffffff' }}>
            ...
            Through{' '}
            <em style={{ fontStyle: 'italic', color: 'rgba(240,244,250,0.55)' }}>Knowledge,</em>
            <br />
            Research &amp; Discovery
          </h1>

          <p style={{ fontSize: '17px', fontWeight: 400, lineHeight: 1.75, color: 'rgba(240,244,250,0.75)', maxWidth: '500px', marginBottom: '44px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <Link href="/live" style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', padding: '14px 28px', border: '1px solid rgba(255,255,255,0.16)', color: 'rgba(240,244,250,0.8)', fontSize: '12px', fontWeight: 400, letterSpacing: '0.12em', textTransform: 'uppercase', textDecoration: 'none', borderRadius: '5px', fontFamily: 'DM Mono, monospace' }}>
        ...
        {/* RIGHT — FEATURED CARD */}
        <div style={{ background: '#10151c', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '16px', overflow: 'hidden' }}>
          ...
          <div style={{ padding: '28px' }}>
            <div style={{ fontFamily: 'DM Mono, monospace', fontSize: '10px', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#c9a96e', marginBottom: '10px' }}>NASA · Saturn Mission</div>
            ...
            <p style={{ fontSize: '14px', fontWeight: 400, lineHeight: 1.7, color: 'rgba(240,244,250,0.75)', marginBottom: '18px' }}>
              Researchers reanalysing Cassini's final passes have found evidence of active hydrothermal vents at Enceladus's seafloor.
            </p>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingTop: '16px', borderTop: '1px solid rgba(255,255,255,0.08)', fontFamily: 'DM Mono, monospace', fontSize: '10px', color: 'rgba(240,244,250,0.45)' }}>

...
**Special relativistic effect (time dilation):** The satellite's velocity causes its clock to run *slower* than Earth-surface clocks by approximately $-7.2$ microseconds per day.

**General relativistic effect (gravitational time dilation):** The weaker gravitational field at altitude causes satellite clocks to run *faster* than surface clocks by approximately $+45.9$ microseconds per day.

The net effect is approximately $+38.4$ microseconds per day — satellite clocks gain 38 microseconds per day relative to Earth clocks. Since GPS position accuracy depends on time measurements accurate to nanoseconds, this ~38,000 nanosecond daily error would accumulate to position errors of roughly **10 km per day** if uncorrected.
